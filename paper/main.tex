...
A Reproducibility-First Pilot Study}
...
failure rules, and a preregisterable multi-seed comparison against prompt-only,
post-hoc, and unmasked baselines. The work explicitly treats skin tone as a
visual attribute and not as a proxy for race or ethnicity.
\end{abstract}
...
demographic error. Finally, the additive update is scheduler-dependent and has
